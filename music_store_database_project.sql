...
Q:3 --Return all the track names that have a song length longer than the average song lengt. Return the Name and Milliseconds for each track. Order by the song length with the 
